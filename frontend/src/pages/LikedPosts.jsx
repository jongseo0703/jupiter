                ...
                <table className="w-full table-fixed">
                  ...
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200">
                      <th className="text-left py-3 px-9 font-semibold text-gray-700" style={{width: '15%'}}>분류</th>
                      <th className="text-left py-3 px-6 font-semibold text-gray-700" style={{width: '30%'}}>제목</th>
