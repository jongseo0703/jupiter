...
public record NotificationSettingsRequest(
    @NotNull(message = "이메일 알림 설정은 필수입니다") Boolean emailNotifications,
    @NotNull(message = "푸시 알림 설정은 필수입니다") Boolean pushNotifications,
    LocalTime notificationStartTime,
    LocalTime notificationEndTime,
    @NotNull(message = "주말 알림 설정은 필수입니다") Boolean weekendNotifications,
